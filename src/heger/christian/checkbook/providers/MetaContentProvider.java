 ...
 * logic accessible from {@link CheckbookContentProvider}.
 * <p>
...
public class MetaContentProvider extends ContentProvider {
	public static final String AUTHORITY = "heger.christian.checkbook.meta";
	...
	protected SQLiteOpenHelper getHelper() {
		if (dbHelper == null) {
			try {
				CheckbookContentProvider buddy = (CheckbookContentProvider) getContext().getContentResolver().acquireContentProviderClient(CheckbookContentProvider.AUTHORITY).getLocalContentProvider();
