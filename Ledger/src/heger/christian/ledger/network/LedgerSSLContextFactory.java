...
public class LedgerSSLContextFactory  {
	 ...
	 */
	public LedgerSSLContextFactory(Context context) throws TruststoreException {
	 ...
	 * @throws TruststoreException If setting up the truststore failed
	 */
	public LedgerSSLContextFactory(InputStream in, String password) throws TruststoreException {
