...
/**
 * <code>SQLiteOpenHelper</code> for the Checkbook database. It uses the singleton pattern to support
 * multiple content providers accessing the same database.
 */
public class CheckbookDbHelper extends SQLiteOpenHelper {
	public static abstract class MonthContract extends heger.christian.checkbook.providers.MonthContract {
	...
	public static abstract class EntryContract extends heger.christian.checkbook.providers.EntryContract {
		protected static final String SQL_CREATE =
	...
	public static abstract class EntryMetaDataContract extends heger.christian.checkbook.providers.EntryMetadataContract {
		protected static final String SQL_CREATE =
				"create table " + TABLE_NAME + "(" +
				BaseColumns._ID + " integer primary key," +
	...
	public static abstract class CategoryContract extends heger.christian.checkbook.providers.CategoryContract {
		protected static final String SQL_CREATE =
				"create table " + TABLE_NAME + " (" +
				BaseColumns._ID + " integer primary key," +
				COL_NAME_CAPTION + " text);";
	...
	public static abstract class RuleContract extends heger.christian.checkbook.providers.RuleContract {
		protected static final String SQL_CREATE =
				"create table " + TABLE_NAME + " (" +
				BaseColumns._ID + " integer primary key," +
	...
	public static abstract class KeyGenerationContract extends heger.christian.checkbook.providers.MetaContentProvider.KeyGenerationContract {
		protected static final String SQL_CREATE =
				"create table " + TABLE_NAME + " (" +
	...
	public static abstract class JournalContract extends heger.christian.checkbook.providers.MetaContentProvider.JournalContract {
		protected static final String SQL_CREATE =
				"create table " + TABLE_NAME + " (" +
...
;
	...
	public static abstract class RevisionTableContract extends heger.christian.checkbook.providers.MetaContentProvider.RevisionTableContract {
		protected static final String SQL_CREATE =
			"create table " + TABLE_NAME + " (" +
			COL_NAME_TABLE + " text not null, " +
			COL_NAME_ROW + " integer not null, " +
	...
	public static abstract class SequenceAnchorContract extends heger.christian.checkbook.providers.MetaContentProvider.SequenceAnchorContract {
		protected static final String SQL_CREATE =
				"create table " + TABLE_NAME + " (" +
	...
	public static final String DB_NAME = "checkbook.db";
