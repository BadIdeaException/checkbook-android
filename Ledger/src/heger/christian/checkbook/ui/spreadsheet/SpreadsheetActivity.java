...
import heger.christian.checkbook.providers.MonthContract;
import heger.christian.checkbook.ui.categories.CategoriesActivity;
import heger.christian.checkbook.ui.entry.EntryActivity;
import heger.christian.checkbook.ui.firstlaunch.FirstLaunchActivity;
import heger.christian.checkbook.ui.rules.RulesActivity;
import heger.christian.checkbook.ui.spreadsheet.SelectMonthDialog.DialogListener;
...
public class SpreadsheetActivity extends FragmentActivity {
	...
	protected static final String PREF_FIRST_START = "first_start";
	...
	protected void onNewIntent(Intent intent) {
		...
		if (uri != null && (CheckbookContentProvider.URI_MATCHER.match(uri) == CheckbookContentProvider.URI_MONTHS_ID)) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// On the first start, show a welcoming screen
